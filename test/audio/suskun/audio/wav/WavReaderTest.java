...
public class WavReaderTest {
    ...
    public void test16KhzStereo() throws IOException {
        ...
        // second channel contains reverse of the first channel.
        float[] expectedFirst10 = {0, 18, -28, -16, -14, -12, 25, 12, 11, 23};
        float[] expectedLast10 ={-23, -27, -5, -14, -30, -26, -28, -29, -25, -33};
